package org.immersed.gaffe.parsing;
...
import org.immersed.gaffe.JavaParser.MethodDeclarationContext;
import org.immersed.gaffe.JavaParser.TypeTypeContext;
import org.immersed.gaffe.JavaParser.TypeTypeOrVoidContext;
...
// }
    ...
    public static void parseFile(String f)
    {
        try
        {
            ...
            parser.addParseListener(new JavaParserBaseListener()
            {
                @Override
                public void exitMethodDeclaration(MethodDeclarationContext ctx)
                {
                    TypeTypeOrVoidContext tov = ctx.typeTypeOrVoid();
                    TerminalNode VOID = tov.VOID();
