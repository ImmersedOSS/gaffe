 ...
 * <p>
 * Functions names match the associated interface.
 * </p>
...
public final class GaffeJdk
{
    ...
    /**
     * Creates a new {@link ThrowingActiveEvent} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> ActiveEvent throwingActiveEvent(ThrowingActiveEvent<X> throwingActiveEvent)
    {
        return throwingActiveEvent;
    }

    /**
     * Creates a new {@link ThrowingComposite} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Composite throwingComposite(ThrowingComposite<X> throwingComposite)
    {
        return throwingComposite;
    }

    /**
     * Creates a new {@link ThrowingKeyEventDispatcher} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingKeyEventDispatcher the interface that can throw check
     *                                   exceptions.
     * @param <X>                        the type of checked exception.
     * @returns the parameter 'throwingKeyEventDispatcher' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingKeyEventPostProcessor} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingKeyEventPostProcessor the interface that can throw check
     *                                      exceptions.
     * @param <X>                           the type of checked exception.
     * @returns the parameter 'throwingKeyEventPostProcessor' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingPrintGraphics} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingStroke} that allows for exceptions to be thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingTransparency} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Transparency throwingTransparency(ThrowingTransparency<X> throwingTransparency)
    {
        return throwingTransparency;
    }

    /**
     * Creates a new {@link ThrowingClipboardOwner} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingClipboardOwner the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingClipboardOwner' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingFlavorListener} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingFlavorListener the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingFlavorListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDragGestureListener} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingDragGestureListener the interface that can throw check
     *                                    exceptions.
     * @param <X>                         the type of checked exception.
     * @returns the parameter 'throwingDragGestureListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDragSourceMotionListener} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingDragSourceMotionListener the interface that can throw check
     *                                         exceptions.
     * @param <X>                              the type of checked exception.
     * @returns the parameter 'throwingDragSourceMotionListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingAWTEventListener} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingAWTEventListener the interface that can throw check
     *                                 exceptions.
     * @param <X>                      the type of checked exception.
     * @returns the parameter 'throwingAWTEventListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingActionListener} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingActionListener the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingActionListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingAdjustmentListener} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingAdjustmentListener the interface that can throw check
     *                                   exceptions.
     * @param <X>                        the type of checked exception.
     * @returns the parameter 'throwingAdjustmentListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingHierarchyListener} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingHierarchyListener the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingHierarchyListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingItemListener} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> ItemListener throwingItemListener(ThrowingItemListener<X> throwingItemListener)
    {
        return throwingItemListener;
    }

    /**
     * Creates a new {@link ThrowingMouseWheelListener} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingMouseWheelListener the interface that can throw check
     *                                   exceptions.
     * @param <X>                        the type of checked exception.
     * @returns the parameter 'throwingMouseWheelListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingTextListener} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> TextListener throwingTextListener(ThrowingTextListener<X> throwingTextListener)
    {
        return throwingTextListener;
    }

    /**
     * Creates a new {@link ThrowingWindowStateListener} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingWindowStateListener the interface that can throw check
     *                                    exceptions.
     * @param <X>                         the type of checked exception.
     * @returns the parameter 'throwingWindowStateListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingImageObserver} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingTileObserver} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> TileObserver throwingTileObserver(ThrowingTileObserver<X> throwingTileObserver)
    {
        return throwingTileObserver;
    }

    /**
     * Creates a new {@link ThrowingRenderedImageFactory} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingRenderedImageFactory the interface that can throw check
     *                                     exceptions.
     * @param <X>                          the type of checked exception.
     * @returns the parameter 'throwingRenderedImageFactory' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingPrintable} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Printable throwingPrintable(ThrowingPrintable<X> throwingPrintable)
    {
        return throwingPrintable;
    }

    /**
     * Creates a new {@link ThrowingPrinterGraphics} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingPrinterGraphics the interface that can throw check exceptions.
     * @param <X>                     the type of checked exception.
     * @returns the parameter 'throwingPrinterGraphics' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingExceptionListener} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingExceptionListener the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingExceptionListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingPropertyChangeListener} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingPropertyChangeListener the interface that can throw check
     *                                       exceptions.
     * @param <X>                            the type of checked exception.
     * @returns the parameter 'throwingPropertyChangeListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingVetoableChangeListener} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingVetoableChangeListener the interface that can throw check
     *                                       exceptions.
     * @param <X>                            the type of checked exception.
     * @returns the parameter 'throwingVetoableChangeListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingBeanContextChildComponentProxy} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingBeanContextChildComponentProxy the interface that can throw
     *                                               check exceptions.
     * @param <X>                                    the type of checked exception.
     * @returns the parameter 'throwingBeanContextChildComponentProxy' behind the
     *          original interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingBeanContextContainerProxy} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingBeanContextContainerProxy the interface that can throw check
     *                                          exceptions.
     * @param <X>                               the type of checked exception.
     * @returns the parameter 'throwingBeanContextContainerProxy' behind the
     *          original interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingBeanContextProxy} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingBeanContextProxy the interface that can throw check
     *                                 exceptions.
     * @param <X>                      the type of checked exception.
     * @returns the parameter 'throwingBeanContextProxy' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingBeanContextServiceRevokedListener} that allows
     * for exceptions to be thrown.
     * 
     * @param throwingBeanContextServiceRevokedListener the interface that can throw
     *                                                  check exceptions.
     * @param <X>                                       the type of checked
     *                                                  exception.
     * @returns the parameter 'throwingBeanContextServiceRevokedListener' behind the
     *          original interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingCloseable} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Closeable throwingCloseable(ThrowingCloseable<X> throwingCloseable)
    {
        return throwingCloseable;
    }

    /**
     * Creates a new {@link ThrowingFileFilter} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> FileFilter throwingFileFilter(ThrowingFileFilter<X> throwingFileFilter)
    {
        return throwingFileFilter;
    }

    /**
     * Creates a new {@link ThrowingFilenameFilter} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingFilenameFilter the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingFilenameFilter' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingFlushable} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Flushable throwingFlushable(ThrowingFlushable<X> throwingFlushable)
    {
        return throwingFlushable;
    }

    /**
     * Creates a new {@link ThrowingObjectInputValidation} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingObjectInputValidation the interface that can throw check
     *                                      exceptions.
     * @param <X>                           the type of checked exception.
     * @returns the parameter 'throwingObjectInputValidation' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingAutoCloseable} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingComparable} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <T, X extends Throwable> Comparable<T> throwingComparable(ThrowingComparable<T, X> throwingComparable)
    {
        return throwingComparable;
    }

    /**
     * Creates a new {@link ThrowingIterable} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <T, X extends Throwable> Iterable<T> throwingIterable(ThrowingIterable<T, X> throwingIterable)
    {
        return throwingIterable;
    }

    /**
     * Creates a new {@link ThrowingReadable} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Readable throwingReadable(ThrowingReadable<X> throwingReadable)
    {
        return throwingReadable;
    }

    /**
     * Creates a new {@link ThrowingRunnable} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingUncaughtExceptionHandler} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingThreadUncaughtExceptionHandler the interface that can throw
     *                                               check exceptions.
     * @param <X>                                    the type of checked exception.
     * @returns the parameter 'throwingThreadUncaughtExceptionHandler' behind the
     *          original interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingClassFileTransformer} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingClassFileTransformer the interface that can throw check
     *                                     exceptions.
     * @param <X>                          the type of checked exception.
     * @returns the parameter 'throwingClassFileTransformer' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingPlatformManagedObject} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingPlatformManagedObject the interface that can throw check
     *                                      exceptions.
     * @param <X>                           the type of checked exception.
     * @returns the parameter 'throwingPlatformManagedObject' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingGenericArrayType} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingGenericArrayType the interface that can throw check
     *                                 exceptions.
     * @param <X>                      the type of checked exception.
     * @returns the parameter 'throwingGenericArrayType' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingInvocationHandler} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingInvocationHandler the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingInvocationHandler' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingContentHandlerFactory} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingContentHandlerFactory the interface that can throw check
     *                                      exceptions.
     * @param <X>                           the type of checked exception.
     * @returns the parameter 'throwingContentHandlerFactory' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingCookiePolicy} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> CookiePolicy throwingCookiePolicy(ThrowingCookiePolicy<X> throwingCookiePolicy)
    {
        return throwingCookiePolicy;
    }

    /**
     * Creates a new {@link ThrowingDatagramSocketImplFactory} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingDatagramSocketImplFactory the interface that can throw check
     *                                          exceptions.
     * @param <X>                               the type of checked exception.
     * @returns the parameter 'throwingDatagramSocketImplFactory' behind the
     *          original interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingFileNameMap} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> FileNameMap throwingFileNameMap(ThrowingFileNameMap<X> throwingFileNameMap)
    {
        return throwingFileNameMap;
    }

    /**
     * Creates a new {@link ThrowingProtocolFamily} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingProtocolFamily the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingProtocolFamily' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingSocketImplFactory} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingSocketImplFactory the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingSocketImplFactory' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingURLStreamHandlerFactory} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingURLStreamHandlerFactory the interface that can throw check
     *                                        exceptions.
     * @param <X>                             the type of checked exception.
     * @returns the parameter 'throwingURLStreamHandlerFactory' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingFilter} that allows for exceptions to be thrown.
     * 
     * @param throwingDirectoryStreamFilter the interface that can throw check
     *                                      exceptions.
     * @param <X>                           the type of checked exception.
     * @returns the parameter 'throwingDirectoryStreamFilter' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingPathMatcher} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> PathMatcher throwingPathMatcher(ThrowingPathMatcher<X> throwingPathMatcher)
    {
        return throwingPathMatcher;
    }

    /**
     * Creates a new {@link ThrowingModifier} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingWatchEventModifier the interface that can throw check
     *                                   exceptions.
     * @param <X>                        the type of checked exception.
     * @returns the parameter 'throwingWatchEventModifier' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingAttributeView} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingFileAttributeView} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingFileAttributeView the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingFileAttributeView' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingFileStoreAttributeView} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingFileStoreAttributeView the interface that can throw check
     *                                       exceptions.
     * @param <X>                            the type of checked exception.
     * @returns the parameter 'throwingFileStoreAttributeView' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingActivationInstantiator} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingActivationInstantiator the interface that can throw check
     *                                       exceptions.
     * @param <X>                            the type of checked exception.
     * @returns the parameter 'throwingActivationInstantiator' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingActivator} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Activator throwingActivator(ThrowingActivator<X> throwingActivator)
    {
        return throwingActivator;
    }

    /**
     * Creates a new {@link ThrowingRMIClientSocketFactory} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingRMIClientSocketFactory the interface that can throw check
     *                                       exceptions.
     * @param <X>                            the type of checked exception.
     * @returns the parameter 'throwingRMIClientSocketFactory' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingRMIFailureHandler} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingRMIFailureHandler the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingRMIFailureHandler' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingRMIServerSocketFactory} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingRMIServerSocketFactory the interface that can throw check
     *                                       exceptions.
     * @param <X>                            the type of checked exception.
     * @returns the parameter 'throwingRMIServerSocketFactory' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingUnreferenced} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Unreferenced throwingUnreferenced(ThrowingUnreferenced<X> throwingUnreferenced)
    {
        return throwingUnreferenced;
    }

    /**
     * Creates a new {@link ThrowingDomainCombiner} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingDomainCombiner the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingDomainCombiner' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingGuard} that allows for exceptions to be thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingLoadStoreParameter} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingKeyStoreLoadStoreParameter the interface that can throw check
     *                                           exceptions.
     * @param <X>                                the type of checked exception.
     * @returns the parameter 'throwingKeyStoreLoadStoreParameter' behind the
     *          original interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingPrivilegedAction} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingPrivilegedAction the interface that can throw check
     *                                 exceptions.
     * @param <X>                      the type of checked exception.
     * @returns the parameter 'throwingPrivilegedAction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingPrivilegedExceptionAction} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingPrivilegedExceptionAction the interface that can throw check
     *                                          exceptions.
     * @param <X>                               the type of checked exception.
     * @returns the parameter 'throwingPrivilegedExceptionAction' behind the
     *          original interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDSAKey} that allows for exceptions to be thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingECKey} that allows for exceptions to be thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingRSAKey} that allows for exceptions to be thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingECField} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingDriverAction} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> DriverAction throwingDriverAction(ThrowingDriverAction<X> throwingDriverAction)
    {
        return throwingDriverAction;
    }

    /**
     * Creates a new {@link ThrowingEra} that allows for exceptions to be thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingTemporalAdjuster} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingTemporalAdjuster the interface that can throw check
     *                                 exceptions.
     * @param <X>                      the type of checked exception.
     * @returns the parameter 'throwingTemporalAdjuster' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingTemporalQuery} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingFormattable} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Formattable throwingFormattable(ThrowingFormattable<X> throwingFormattable)
    {
        return throwingFormattable;
    }

    /**
     * Creates a new {@link ThrowingObserver} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Observer throwingObserver(ThrowingObserver<X> throwingObserver)
    {
        return throwingObserver;
    }

    /**
     * Creates a new {@link ThrowingCallable} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <V, X extends Throwable> Callable<V> throwingCallable(ThrowingCallable<V, X> throwingCallable)
    {
        return throwingCallable;
    }

    /**
     * Creates a new {@link ThrowingExecutor} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> Executor throwingExecutor(ThrowingExecutor<X> throwingExecutor)
    {
        return throwingExecutor;
    }

    /**
     * Creates a new {@link ThrowingForkJoinWorkerThreadFactory} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingForkJoinPoolForkJoinWorkerThreadFactory the interface that can
     *                                                        throw check
     *                                                        exceptions.
     * @param <X>                                             the type of checked
     *                                                        exception.
     * @returns the parameter 'throwingForkJoinPoolForkJoinWorkerThreadFactory'
     *          behind the original interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingRejectedExecutionHandler} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingRejectedExecutionHandler the interface that can throw check
     *                                         exceptions.
     * @param <X>                              the type of checked exception.
     * @returns the parameter 'throwingRejectedExecutionHandler' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingThreadFactory} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingBiConsumer} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingBiFunction} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingBiPredicate} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingBinaryOperator} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingBinaryOperator the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingBinaryOperator' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingBooleanSupplier} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingBooleanSupplier the interface that can throw check exceptions.
     * @param <X>                     the type of checked exception.
     * @returns the parameter 'throwingBooleanSupplier' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingConsumer} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingDoubleBinaryOperator} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingDoubleBinaryOperator the interface that can throw check
     *                                     exceptions.
     * @param <X>                          the type of checked exception.
     * @returns the parameter 'throwingDoubleBinaryOperator' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDoubleConsumer} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingDoubleConsumer the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingDoubleConsumer' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDoubleFunction} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingDoubleFunction the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingDoubleFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDoublePredicate} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingDoublePredicate the interface that can throw check exceptions.
     * @param <X>                     the type of checked exception.
     * @returns the parameter 'throwingDoublePredicate' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDoubleSupplier} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingDoubleSupplier the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingDoubleSupplier' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDoubleToIntFunction} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingDoubleToIntFunction the interface that can throw check
     *                                    exceptions.
     * @param <X>                         the type of checked exception.
     * @returns the parameter 'throwingDoubleToIntFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDoubleToLongFunction} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingDoubleToLongFunction the interface that can throw check
     *                                     exceptions.
     * @param <X>                          the type of checked exception.
     * @returns the parameter 'throwingDoubleToLongFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDoubleUnaryOperator} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingDoubleUnaryOperator the interface that can throw check
     *                                    exceptions.
     * @param <X>                         the type of checked exception.
     * @returns the parameter 'throwingDoubleUnaryOperator' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingFunction} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingIntBinaryOperator} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingIntBinaryOperator the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingIntBinaryOperator' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingIntConsumer} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> IntConsumer throwingIntConsumer(ThrowingIntConsumer<X> throwingIntConsumer)
    {
        return throwingIntConsumer;
    }

    /**
     * Creates a new {@link ThrowingIntFunction} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingIntPredicate} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> IntPredicate throwingIntPredicate(ThrowingIntPredicate<X> throwingIntPredicate)
    {
        return throwingIntPredicate;
    }

    /**
     * Creates a new {@link ThrowingIntSupplier} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> IntSupplier throwingIntSupplier(ThrowingIntSupplier<X> throwingIntSupplier)
    {
        return throwingIntSupplier;
    }

    /**
     * Creates a new {@link ThrowingIntToDoubleFunction} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingIntToDoubleFunction the interface that can throw check
     *                                    exceptions.
     * @param <X>                         the type of checked exception.
     * @returns the parameter 'throwingIntToDoubleFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingIntToLongFunction} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingIntToLongFunction the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingIntToLongFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingIntUnaryOperator} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingIntUnaryOperator the interface that can throw check
     *                                 exceptions.
     * @param <X>                      the type of checked exception.
     * @returns the parameter 'throwingIntUnaryOperator' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingLongBinaryOperator} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingLongBinaryOperator the interface that can throw check
     *                                   exceptions.
     * @param <X>                        the type of checked exception.
     * @returns the parameter 'throwingLongBinaryOperator' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingLongConsumer} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> LongConsumer throwingLongConsumer(ThrowingLongConsumer<X> throwingLongConsumer)
    {
        return throwingLongConsumer;
    }

    /**
     * Creates a new {@link ThrowingLongFunction} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingLongPredicate} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingLongSupplier} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> LongSupplier throwingLongSupplier(ThrowingLongSupplier<X> throwingLongSupplier)
    {
        return throwingLongSupplier;
    }

    /**
     * Creates a new {@link ThrowingLongToDoubleFunction} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingLongToDoubleFunction the interface that can throw check
     *                                     exceptions.
     * @param <X>                          the type of checked exception.
     * @returns the parameter 'throwingLongToDoubleFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingLongToIntFunction} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingLongToIntFunction the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingLongToIntFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingLongUnaryOperator} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingLongUnaryOperator the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingLongUnaryOperator' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingObjDoubleConsumer} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingObjDoubleConsumer the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingObjDoubleConsumer' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingObjIntConsumer} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingObjIntConsumer the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingObjIntConsumer' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingObjLongConsumer} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingObjLongConsumer the interface that can throw check exceptions.
     * @param <X>                     the type of checked exception.
     * @returns the parameter 'throwingObjLongConsumer' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingPredicate} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingSupplier} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingToDoubleBiFunction} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingToDoubleBiFunction the interface that can throw check
     *                                   exceptions.
     * @param <X>                        the type of checked exception.
     * @returns the parameter 'throwingToDoubleBiFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingToDoubleFunction} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingToDoubleFunction the interface that can throw check
     *                                 exceptions.
     * @param <X>                      the type of checked exception.
     * @returns the parameter 'throwingToDoubleFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingToIntBiFunction} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingToIntBiFunction the interface that can throw check exceptions.
     * @param <X>                     the type of checked exception.
     * @returns the parameter 'throwingToIntBiFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingToIntFunction} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingToLongBiFunction} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingToLongBiFunction the interface that can throw check
     *                                 exceptions.
     * @param <X>                      the type of checked exception.
     * @returns the parameter 'throwingToLongBiFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingToLongFunction} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingToLongFunction the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingToLongFunction' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingUnaryOperator} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingPreferenceChangeListener} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingPreferenceChangeListener the interface that can throw check
     *                                         exceptions.
     * @param <X>                              the type of checked exception.
     * @returns the parameter 'throwingPreferenceChangeListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingResourceBundleControlProvider} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingResourceBundleControlProvider the interface that can throw
     *                                              check exceptions.
     * @param <X>                                   the type of checked exception.
     * @returns the parameter 'throwingResourceBundleControlProvider' behind the
     *          original interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingInterpolatable} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingInterpolatable the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingInterpolatable' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingInvalidationListener} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingInvalidationListener the interface that can throw check
     *                                     exceptions.
     * @param <X>                          the type of checked exception.
     * @returns the parameter 'throwingInvalidationListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingWeakListener} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> WeakListener throwingWeakListener(ThrowingWeakListener<X> throwingWeakListener)
    {
        return throwingWeakListener;
    }

    /**
     * Creates a new {@link ThrowingChangeListener} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingChangeListener the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingChangeListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingArrayChangeListener} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingArrayChangeListener the interface that can throw check
     *                                    exceptions.
     * @param <X>                         the type of checked exception.
     * @returns the parameter 'throwingArrayChangeListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingListChangeListener} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingListChangeListener the interface that can throw check
     *                                   exceptions.
     * @param <X>                        the type of checked exception.
     * @returns the parameter 'throwingListChangeListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingMapChangeListener} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingMapChangeListener the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingMapChangeListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingSetChangeListener} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingSetChangeListener the interface that can throw check
     *                                  exceptions.
     * @param <X>                       the type of checked exception.
     * @returns the parameter 'throwingSetChangeListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingEventDispatcher} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingEventDispatcher the interface that can throw check exceptions.
     * @param <X>                     the type of checked exception.
     * @returns the parameter 'throwingEventDispatcher' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingEventHandler} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingEventTarget} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> EventTarget throwingEventTarget(ThrowingEventTarget<X> throwingEventTarget)
    {
        return throwingEventTarget;
    }

    /**
     * Creates a new {@link ThrowingInitializable} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingAudioSpectrumListener} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingAudioSpectrumListener the interface that can throw check
     *                                      exceptions.
     * @param <X>                           the type of checked exception.
     * @returns the parameter 'throwingAudioSpectrumListener' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingBuilder} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <T, X extends Throwable> Builder<T> throwingBuilder(ThrowingBuilder<T, X> throwingBuilder)
    {
        return throwingBuilder;
    }

    /**
     * Creates a new {@link ThrowingBuilderFactory} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingBuilderFactory the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingBuilderFactory' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingCallback} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingDomainManagerOperations} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingDomainManagerOperations the interface that can throw check
     *                                        exceptions.
     * @param <X>                             the type of checked exception.
     * @returns the parameter 'throwingDomainManagerOperations' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingInvokeHandler} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingValueBase} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> ValueBase throwingValueBase(ThrowingValueBase<X> throwingValueBase)
    {
        return throwingValueBase;
    }

    /**
     * Creates a new {@link ThrowingValueFactory} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> ValueFactory throwingValueFactory(ThrowingValueFactory<X> throwingValueFactory)
    {
        return throwingValueFactory;
    }

    /**
     * Creates a new {@link ThrowingCodecFactoryOperations} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingCodecFactoryOperations the interface that can throw check
     *                                       exceptions.
     * @param <X>                            the type of checked exception.
     * @returns the parameter 'throwingCodecFactoryOperations' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingPolicyFactoryOperations} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingPolicyFactoryOperations the interface that can throw check
     *                                        exceptions.
     * @param <X>                             the type of checked exception.
     * @returns the parameter 'throwingPolicyFactoryOperations' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingAdapterActivatorOperations} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingAdapterActivatorOperations the interface that can throw check
     *                                           exceptions.
     * @param <X>                                the type of checked exception.
     * @returns the parameter 'throwingAdapterActivatorOperations' behind the
     *          original interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDOMErrorHandler} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingDOMErrorHandler the interface that can throw check exceptions.
     * @param <X>                     the type of checked exception.
     * @returns the parameter 'throwingDOMErrorHandler' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingUserDataHandler} that allows for exceptions to
     * be thrown.
     * 
     * @param throwingUserDataHandler the interface that can throw check exceptions.
     * @param <X>                     the type of checked exception.
     * @returns the parameter 'throwingUserDataHandler' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingElementCSSInlineStyle} that allows for
     * exceptions to be thrown.
     * 
     * @param throwingElementCSSInlineStyle the interface that can throw check
     *                                      exceptions.
     * @param <X>                           the type of checked exception.
     * @returns the parameter 'throwingElementCSSInlineStyle' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDocumentEvent} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingEventListener} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingLSResourceResolver} that allows for exceptions
     * to be thrown.
     * 
     * @param throwingLSResourceResolver the interface that can throw check
     *                                   exceptions.
     * @param <X>                        the type of checked exception.
     * @returns the parameter 'throwingLSResourceResolver' behind the original
     *          interface.
     */
    ...
    /**
     * Creates a new {@link ThrowingDocumentRange} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingDocumentStyle} that allows for exceptions to be
     * thrown.
     * 
    ...
    /**
     * Creates a new {@link ThrowingLinkStyle} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> LinkStyle throwingLinkStyle(ThrowingLinkStyle<X> throwingLinkStyle)
    {
        return throwingLinkStyle;
    }

    /**
     * Creates a new {@link ThrowingNodeFilter} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> NodeFilter throwingNodeFilter(ThrowingNodeFilter<X> throwingNodeFilter)
    {
        return throwingNodeFilter;
    }

    /**
     * Creates a new {@link ThrowingAbstractView} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> AbstractView throwingAbstractView(ThrowingAbstractView<X> throwingAbstractView)
    {
        return throwingAbstractView;
    }

    /**
     * Creates a new {@link ThrowingDocumentView} that allows for exceptions to be
     * thrown.
     * 
     ...
     */
    public static <X extends Throwable> DocumentView throwingDocumentView(ThrowingDocumentView<X> throwingDocumentView)
    {
        return throwingDocumentView;
    }

    /**
     * Creates a new {@link ThrowingEntityResolver} that allows for exceptions to be
     * thrown.
     * 
     * @param throwingEntityResolver the interface that can throw check exceptions.
     * @param <X>                    the type of checked exception.
     * @returns the parameter 'throwingEntityResolver' behind the original
     *          interface.
     */
