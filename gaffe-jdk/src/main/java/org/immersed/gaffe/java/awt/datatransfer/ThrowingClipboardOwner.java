...
public interface ThrowingClipboardOwner<X extends Throwable> extends ClipboardOwner {
  @Override
  @SneakyThrows
  default void lostOwnership(java.awt.datatransfer.Clipboard clipboard,
   ...
   */
  void tryLostOwnership(java.awt.datatransfer.Clipboard clipboard,
      java.awt.datatransfer.Transferable contents) throws X;
}
