...
public interface ThrowingImageObserver<X extends Throwable> extends ImageObserver {
  @Override
  @SneakyThrows
  default boolean imageUpdate(java.awt.Image img, int infoflags, int x, int y, int width,
      int height) {
   ...
   */
  boolean tryImageUpdate(java.awt.Image img, int infoflags, int x, int y, int width, int height)
      throws X;
}
