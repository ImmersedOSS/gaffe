...
public interface ThrowingTileObserver<X extends Throwable> extends TileObserver
{
    @Override
    @SneakyThrows
    default void tileUpdate(java.awt.image.WritableRenderedImage source, int tileX, int tileY, boolean willBeWritable)
    {
     ...
     */
    void tryTileUpdate(java.awt.image.WritableRenderedImage source, int tileX, int tileY, boolean willBeWritable)
            throws X;
}
