...
public interface ThrowingPrintable<X extends Throwable> extends Printable {
  @Override
  @SneakyThrows
  default int print(java.awt.Graphics graphics, java.awt.print.PageFormat pageFormat,
      int pageIndex) {
   ...
   */
  int tryPrint(java.awt.Graphics graphics, java.awt.print.PageFormat pageFormat, int pageIndex)
      throws X;
}
