...
public interface ThrowingGenericArrayType<X extends Throwable> extends GenericArrayType
{
     ...
     * This method creates the component type of the array. See the declaration of
     * {@link java.lang.reflect.ParameterizedType ParameterizedType} for the
     * semantics of the creation process for parameterized types and see
     * {@link java.lang.reflect.TypeVariable TypeVariable} for the creation process
     * for type variables.
     *
     ...
     *                                             component type refers to a
     *                                             non-existent type declaration
     * @throws MalformedParameterizedTypeException if the underlying array type's
     *                                             component type refers to a
