...
public interface ThrowingInvocationHandler<X extends Throwable> extends InvocationHandler
{
     ...
     *         this method is {@code null} and the interface method's return type is
     ...
     *         this method is otherwise not compatible with the interface method's
     *         declared return type as described above, a {@code ClassCastException}
     ...
     *                   {@code java.lang.RuntimeException} or
     *                   {@code java.lang.Error}. If a checked exception is thrown
     *                   by this method that is not assignable to any of the
     *                   exception types declared in the {@code throws} clause of
     *                   the interface method, then an
     *                   {@link UndeclaredThrowableException} containing the
     *                   exception that was thrown by this method will be thrown by
     ...
     */
    java.lang.Object tryInvoke(java.lang.Object proxy, java.lang.reflect.Method method, java.lang.Object[] args)
            throws X;
}
