...
public interface ThrowingRMIServerSocketFactory<X extends Throwable> extends RMIServerSocketFactory
{
    @Override
    @SneakyThrows
    default java.net.ServerSocket createServerSocket(int port)
    {
        return tryCreateServerSocket(port);
    }
     ...
     */
    java.net.ServerSocket tryCreateServerSocket(int port) throws X;
}
