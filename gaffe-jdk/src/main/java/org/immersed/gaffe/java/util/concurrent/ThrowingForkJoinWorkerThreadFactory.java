...
public interface ThrowingForkJoinWorkerThreadFactory<X extends Throwable> extends ForkJoinPool.ForkJoinWorkerThreadFactory {
  @Override
  @SneakyThrows
  default java.util.concurrent.ForkJoinWorkerThread newThread(
   ...
   */
  java.util.concurrent.ForkJoinWorkerThread tryNewThread(java.util.concurrent.ForkJoinPool pool)
      throws X;
}
