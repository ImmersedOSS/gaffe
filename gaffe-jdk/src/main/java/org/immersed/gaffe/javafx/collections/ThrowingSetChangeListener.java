...
public interface ThrowingSetChangeListener<E, X extends Throwable> extends SetChangeListener<E>
{
    ...
    /**
     * Called after a change has been made to an ObservableSet. This method is
     * called on every elementary change (add/remove) once. This means, complex
     * changes like removeAll(Collection) or clear() may result in more than one
     * call of onChanged method.
     *
