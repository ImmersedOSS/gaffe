...
public interface ThrowingPolicyFactoryOperations<X extends Throwable> extends PolicyFactoryOperations
{
     ...
     * <code>PolicyFactory</code> instance when <code>CORBA.ORB.create_policy</code>
     * is called for the <code>PolicyType</code> under which the
     * <code>PolicyFactory</code> has been registered. The
     * <code>create_policy</code> operation then returns an instance of the
     * appropriate interface derived from <code>CORBA.Policy</code> whose value
     * corresponds to the specified any. If it cannot, it shall throw an exception
     * as described for <code>CORBA.ORB.create_policy</code>.
     *
     ...
     * @return A <code>CORBA.Policy<code> object of the specified type and value.
     *
