...
public interface ThrowingUserDataHandler<X extends Throwable> extends UserDataHandler
{
    @Override
    @SneakyThrows
    default void handle(short operation, java.lang.String key, java.lang.Object data, org.w3c.dom.Node src,
     ...
     * is imported or cloned. <br>
     * DOM applications must not raise exceptions in a <code>UserDataHandler</code>.
     * The effect of throwing exceptions from the handler is DOM implementation
     * dependent.
     * 
     * @param operation Specifies the type of operation that is being performed on
     *                  the node.
