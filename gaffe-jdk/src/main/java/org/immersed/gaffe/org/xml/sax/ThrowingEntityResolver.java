...
public interface ThrowingEntityResolver<X extends Throwable> extends EntityResolver
{
    @Override
    @SneakyThrows
    default org.xml.sax.InputSource resolveEntity(java.lang.String publicId, java.lang.String systemId)
    {
        return tryResolveEntity(publicId, systemId);
    }
     ...
     * method, and that if none is returned, then the system ID will be dereferenced
     * as a URL.
     * </p>
     *
     * <p>
     ...
     *                                     another exception.
     * @exception java.io.IOException      A Java-specific IO exception, possibly
     ...
     */
    org.xml.sax.InputSource tryResolveEntity(java.lang.String publicId, java.lang.String systemId) throws X;
}
